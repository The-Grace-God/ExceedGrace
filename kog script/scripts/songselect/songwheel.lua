...
function drawSong(song, y)
    ...
    if (top50diffs[selectedSongDifficulty.id]) then
        ...
        VfWindow.render(0,songX+95, y+105,24*1.5,volforceAmount,false,true,false)
    end
end
...
function drawData() -- Draws the song data on the left panel
    ...
    if (top50diffs[diff.id]) then
        ...
        VfWindow.render(0,85, 600,24*3,volforceAmount,false,true,false)
    end
    ...
    gfx.Text(percentText.." %", 335+(1-transitionAfterscrollTextSongArtist)*30, 838)
